...
<html>
  ...
  <body>
    <header
      id="header"
      class="site-header position-fixed z-2 w-100 border-bottom mb-5"
    >
      <nav id="header-nav" class="navbar navbar-expand-lg py-3">
        <div class="container-lg">
          ...
          <button
            class="navbar-toggler d-flex d-lg-none order-3 p-2 border-0 shadow-none bg-white"
            type="button"
          ...
          >
            ...
            <div class="offcanvas-body">
              <ul
                class="navbar-nav scrollspy-nav justify-content-end flex-grow-1 gap-lg-5 pe-3"
              >
      ...
      <div class="container-lg">
        <div class="row align-items-center text-center py-5 mt-5">
          <div class="col-lg-6 mb-5">
            ...
            <a
              href="#landing-pages"
              class="btn btn-lg btn-primary rounded-pill text-uppercase mb-3"
              data-aos="fade-up"
              data-aos-delay="600"
              >Перейти к сервису</a
            >
    ...
    <section id="services" class="scrollspy-section py-lg-7">
      <div class="container-lg">
        <div
          class="col-lg-7 text-center mx-auto py-5"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          <h2 class="display-3 fw-bold">Почему AQUA Navigator?</h2>
          <p class="lead m-4">
            AQUA Navigator - сервис для поиска бассейнов. Находите ближайшие объекты, получайте информацию о расписании, ценах и отзывах. 
          ...
          <div class="contact-content">
            <div class="row">
              <div class="col-lg-4 col-md-6 mb-3">
                <div
                  class="icon-box d-flex flex-wrap align-items-center justify-content-center border rounded-4 p-5"
                >
